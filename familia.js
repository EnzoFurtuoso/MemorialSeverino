export const familia = [
  {
    ...
    netos: [
      {
        nome: "Tatiane",
        foto: "./img/Netos/Tati.jpg",
        bisnetos: [
          { nome: "Jhennyffer", foto: "./img/Bisnetos/jhenny.jpeg" },
          { nome: "Layla", foto: "./img/Bisnetos/layla.jpeg" },
        ],
      },
...

  {
    ...
    netos: [{ nome: "Aparecido(Cido)", foto: "./img/Netos/cido.png" }],
  },
...

  {
    ...
    netos: [
      {
        nome: "Anderson",
        foto: "./img/Netos/anderson.jpeg",
        bisnetos: [{ nome: "Mariana", foto: "./img/Bisnetos/mariana.jpg" }],
      },
...

  {
    ...
    netos: [{ nome: "Guilherme", foto: "./img/Netos/Gui.jpg" }],
  },
];
